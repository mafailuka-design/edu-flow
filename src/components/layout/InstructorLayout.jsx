      ...
      <div className="flex-1 flex max-w-7xl w-full mx-auto">
          ...
          <div className="fixed inset-0 z-50 md:hidden flex">
            ...
            <div className="relative w-72 max-w-[80vw] bg-white h-full z-10 shadow-2xl flex flex-col">
              <div className="p-4 border-b border-slate-100 flex items-center justify-between">
                <span className="font-bold text-slate-900">Instructor Navigation</span>
                <button
                  onClick={() => setMobileSidebarOpen(false)}
              ...
              <div className="flex-1 overflow-y-auto">
                <InstructorSidebar onCloseMobile={() => setMobileSidebarOpen(false)} />
              </div>
            </div>
          </div>
        )}
        ...
        <main className="flex-1 min-w-0 p-4 sm:p-6 lg:p-8">
          ...
          <div className="md:hidden flex items-center justify-between pb-4 mb-4 border-b border-slate-200">
            ...
            <span className="text-xs font-semibold text-purple-600 font-bold">Instructor Portal</span>
          </div>
